...
def main():
    ...
    run_name = f"{cfg.run_cfg.wandb_name}-{num_dirs}"
    output_dir = os.path.join(cfg.run_cfg.output_dir, run_name)
    cfg.run_cfg.output_dir = output_dir
    ...
    eval_result = runner.evaluate(skip_reload=False)
