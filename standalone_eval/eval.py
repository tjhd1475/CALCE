...
def eval_main():
    ...
    parser.add_argument("--submission_path", default='/data2/xiepeiyu/save/mrhd_BLIP/QVH/QVH_CLUSTER_CAP_FILTER_EVAL/result/hl_val_submission.jsonl', type=str, help="path to generated prediction file")
    parser.add_argument("--gt_path",default='/data2/xiepeiyu/qvhighlights/annotations/highlight_val_release.jsonl', type=str, help="path to GT file")
    parser.add_argument("--save_path",default='standalone_eval/val_preds_metrics.json', type=str, help="path to save the results")
