...
from lavis.models.blip2_calce_models.blip2_calce_stage1 import BLIP2_CALCE_STAGE1
from lavis.models.blip2_calce_models.blip2_calce_stage2 import BLIP2_CALCE_STAGE2
...
class ModelZoo:
    ...
    def __init__(self) -> None:
        self.model_zoo = {
            k: list(v[0].PRETRAINED_MODEL_CONFIG_DICT.keys())
